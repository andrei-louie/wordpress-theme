...
class Clock_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Clock', // Name
			[ 'description' => __( 'Clock Widget', 'netwarriorservices' ), ] // Args
		);
	}
	...
	public function form( $instance ) {
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'New title', 'netwarriorservices' );
		}
		?>
		<p>
			<label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Title:', 'netwarriorservices' ); ?></label>
