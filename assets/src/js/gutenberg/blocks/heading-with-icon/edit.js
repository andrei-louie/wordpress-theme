...
const Edit = ( props ) => {
	...
	return (
		<div className="netwarriorservices-icon-heading">
			<span className="netwarriorservices-icon-heading__heading">
				<HeadingIcon />
			</span>
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'netwarriorservices' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'netwarriorservices' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'netwarriorservices' ) }
						help={ __( 'Controls icon selection', 'netwarriorservices' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
